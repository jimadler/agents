...
def update_intel_board():
    with open('/hermes/projects/vanguard-space-search/targets.txt', 'r') as f:
    ...
    with open('/hermes/projects/vanguard-space-search/index.html', 'r') as f:
        content = f.read()
    ...
    with open('/hermes/projects/vanguard-space-search/index.html', 'w') as f:
        f.write(new_content)
